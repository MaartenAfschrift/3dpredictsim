...
int F_generic(const T** arg, T** res) {
	...
	model = new OpenSim::Model();
	 /// Body specifications
    pelvis = new OpenSim::Body("pelvis", 11.77, Vec3(-0.0707 0 0), Inertia(0.1028, 0.0871, 0.0579, 0, 0, 0));
    femur_l = new OpenSim::Body("femur_l", 9.3, Vec3(0, -0.17, 0), Inertia(0.1339, 0.0351, 0.1412, 0, 0, 0));
    femur_r = new OpenSim::Body("femur_r", 9.3, Vec3(0, -0.17, 0), Inertia(0.1339, 0.0351, 0.1412, 0, 0, 0));
    tibia_l = new OpenSim::Body("tibia_l", 3.7, Vec3(0, -0.1867, 0), Inertia(0.0504, 0.005, 0.0511, 0, 0));
    tibia_r = new OpenSim::Body("tibia_r", 3.7, Vec3(0, -0.1867, 0), Inertia(0.0504, 0.005, 0.0511, 0, 0));
    talus_l = new OpenSim::Body("talus_l", 0.1, Vec3(0, 0, 0), Inertia(0.001, 0.001, 0.001, 0, 0, 0));
    talus_r = new OpenSim::Body("talus_r", 0.1, Vec3(0, 0, 0), Inertia(0.001, 0.001, 0.001, 0, 0, 0));
    calcn_l = new OpenSim::Body("calcn_l", 1.25, Vec3(0.1, 0.03, 0), Inertia(0.0014, 0.0039, 0.0041, 0, 0, 0));
    calcn_r = new OpenSim::Body("calcn_r", 1.25, Vec3(0.1, 0.03, 0), Inertia(0.0014, 0.0039, 0.0041, 0, 0, 0));
    toes_l = new OpenSim::Body("toes_l", 0.216, Vec3(0.0346, 0.006, -0.0175), Inertia(0.0001, 0.002, 0.001, 0, 0, 0));
    toes_r = new OpenSim::Body("toes_r", 0.216, Vec3(0.0346, 0.006, -0.0175), Inertia(0.0001, 0.002, 0.001, 0, 0, 0));
    torso = new OpenSim::Body("torso", 26.826, Vec3(-0.03, 0.32, 0), Inertia(1.4745, 0.7555, 1.4314, 0, 0, 0));
    humerus_l = new OpenSim::Body("humerus_l", 2.0325, Vec3(0, -0.1645, 0), Inertia(0.012, 0.0041, 0.0134, 0, 0, 0));
    humerus_r = new OpenSim::Body("humerus_r", 2.0325, Vec3(0, -0.1645, 0), Inertia(0.012, 0.0041, 0.0134, 0, 0, 0));
    ulna_l = new OpenSim::Body("ulna_l", 0.6075, Vec3(0, -0.12, 0), Inertia(0.002962, 0.000618, 0.003213, 0, 0, 0));
    ulna_r = new OpenSim::Body("ulna_r", 0.6075, Vec3(0, -0.12, 0), Inertia(0.002962, 0.000618, 0.003213, 0, 0, 0));
    radius_l = new OpenSim::Body("radius_l", 0.6075, Vec3(0, -0.12, 0), Inertia(0.002962, 0.000618, 0.003213, 0, 0, 0));
    radius_r = new OpenSim::Body("radius_r", 0.6075, Vec3(0, -0.12, 0), Inertia(0.002962, 0.000618, 0.003213, 0, 0, 0));
    hand_l = new OpenSim::Body("hand_l", 0.4575, Vec3(0, -0.068, 0), Inertia(0.000892, 0.000547, 0.00134, 0, 0, 0));
    hand_r = new OpenSim::Body("hand_r", 0.4575, Vec3(0, -0.068, 0), Inertia(0.000892, 0.000547, 0.00134, 0, 0, 0));
    /// Joints
    ...
    hip_l = new CustomJoint("hip_l", *pelvis, Vec3(-0.0562, -0.07849, -0.07726), Vec3(0), *femur_l, Vec3(0), Vec3(0), st_hip_l);
    hip_r = new CustomJoint("hip_r", *pelvis, Vec3(-0.0562, -0.07849, 0.07726), Vec3(0), *femur_r, Vec3(0), Vec3(0), st_hip_r);
    knee_l = new CustomJoint("knee_l", *femur_l, Vec3(-0.00809, -0.40796, 0.00275), Vec3(0), *tibia_l, Vec3(0), Vec3(0), st_knee_l);
    knee_r = new CustomJoint("knee_r", *femur_r, Vec3(-0.00809, -0.40796, -0.00275), Vec3(0), *tibia_r, Vec3(0), Vec3(0), st_knee_r);
    ankle_l = new CustomJoint("ankle_l", *tibia_l, Vec3(-0.01, -0.4, 0), Vec3(0), *talus_l, Vec3(0), Vec3(0), st_ankle_l);
    ankle_r = new CustomJoint("ankle_r", *tibia_r, Vec3(-0.01, -0.4, 0), Vec3(0), *talus_r, Vec3(0), Vec3(0), st_ankle_r);
    subtalar_l = new CustomJoint("subtalar_l", *talus_l, Vec3(-0.04877, -0.04195, -0.00792), Vec3(0), *calcn_l, Vec3(0), Vec3(0),st_subtalar_l);
    subtalar_r = new CustomJoint("subtalar_r", *talus_r, Vec3(-0.04877, -0.04195, -0.00792), Vec3(0), *calcn_r, Vec3(0), Vec3(0),st_subtalar_r);
    mtp_l = new PinJoint("mtp_l", *calcn_l, Vec3(0.1788, -0.002, -0.00108), Vec3(0), *toes_l, Vec3(0), Vec3(0));
    mtp_r = new PinJoint("mtp_r", *calcn_r, Vec3(0.1788, -0.002, 0.00108), Vec3(0), *toes_r, Vec3(0), Vec3(0));
    back = new CustomJoint("back", *pelvis, Vec3(-0.1007, 0.0815, 0), Vec3(0), *torso, Vec3(0), Vec3(0), st_back);
    shoulder_l = new CustomJoint("shoulder_l", *torso, Vec3(0.003155, 0.3715, -0.17), Vec3(0), *humerus_l, Vec3(0), Vec3(0), st_sho_l);
    shoulder_r = new CustomJoint("shoulder_r", *torso, Vec3(0.003155, 0.3715, 0.17), Vec3(0), *humerus_r, Vec3(0), Vec3(0), st_sho_r);
    elbow_l = new CustomJoint("elbow_l", *humerus_l, Vec3(0.013144, -0.286273, 0.009595), Vec3(0), *ulna_l, Vec3(0), Vec3(0), st_elb_l);
    elbow_r = new CustomJoint("elbow_r", *humerus_r, Vec3(0.013144, -0.286273, -0.0095958), Vec3(0), *ulna_r, Vec3(0), Vec3(0), st_elb_r);
    radioulnar_l = new CustomJoint("radioulnar_l", *ulna_l, Vec3(-0.006727, -0.013007, -0.026083), Vec3(0), *radius_l, Vec3(0), Vec3(0),st_radioulnar_l);
    radioulnar_r = new CustomJoint("radioulnar_r", *ulna_r, Vec3(-0.006727, -0.013007, 0.026083), Vec3(0), *radius_r, Vec3(0), Vec3(0),st_radioulnar_r);
    radius_hand_l = new WeldJoint("radius_hand_l", *radius_l, Vec3(-0.008797, -0.235841, 0.01361), Vec3(0), *hand_l, Vec3(0), Vec3(0));
    radius_hand_r = new WeldJoint("radius_hand_r", *radius_r, Vec3(-0.008797, -0.235841, -0.01361), Vec3(0), *hand_r, Vec3(0), Vec3(0));
